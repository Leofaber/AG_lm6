...
const PilDescription paramsDescr[] = {
    ...
    { PilBool, "isExpMapsNormalized", "If 'yes' (or 'y') you assert that the exp-maps are already normalized. Insert 'no' (or 'n') instead" },
    ...
    { PilBool, "binSumOnNormalizedMap","If 'yes' (or 'y') compute bin sum on normalized maps"},
