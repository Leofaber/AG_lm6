...
/*
	const char *ctsT0FilePath = "../T0.cts.gz";
	const char *expT0FilePath = "../T0.exp.gz";
	const char *ctsT1FilePath = "../T1.cts.gz";
	const char *expT1FilePath = "../T1.exp.gz";
	const char *ctsT2FilePath = "../T2.cts.gz";
	const char *expT2FilePath = "../T2.exp.gz";
	double l = 45;
	double b = 30;
	double radius = 10;
...
*/
	...
	if(statusCts == 0 && statusExp==0) {
		resText << setprecision(2);
		resText << "off " << bkg << " " << expT1.photonsCount + expT2.photonsCount << " " << setprecision(10) << bkg / (double) (expT1.photonsCount + expT2.photonsCount);
	}
